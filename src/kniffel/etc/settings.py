...
def main(ASSETS_PATH):
    ...
    settings = {
        ...
        "window_icon": os.path.join(ASSETS_PATH, "window_icon.png"), # The icon of the game
        ...
        "font": os.path.join(ASSETS_PATH, "fonts", "machinegunk.ttf"), # The font of the text in the game window

        "intro_video": os.path.join(ASSETS_PATH, "videos", "kniffel_intro.mp4"), # Short intro video which is played when the game starts
        ...
        "dice_images": {
            ...
            1: os.path.join(ASSETS_PATH, "dice_numbers", "one.png"),
            2: os.path.join(ASSETS_PATH, "dice_numbers", "two.png"),
            3: os.path.join(ASSETS_PATH, "dice_numbers", "three.png"),
            4: os.path.join(ASSETS_PATH, "dice_numbers", "four.png"),
            5: os.path.join(ASSETS_PATH, "dice_numbers", "five.png"),
            6: os.path.join(ASSETS_PATH, "dice_numbers", "six.png"),
        },
        ...
        "window_music": os.path.join(ASSETS_PATH, "music", "background_music.mp3"), # Background music path
